...
<header>
    ...
    <div class="slide-menu">
        ...
        ?>
        <li style="border-bottom: outset; background-color: #a9a9a9;">現在地：　<?php echo $class_name; ?></li>
        <li style="border-bottom: outset; background-color: #a9a9a9;">
        ...
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="map.php">MAP</a></li>
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="favorite.php">お気に入り</a></li>
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="qr_read.php">QRカメラ</a></li>
        <?php echo '<li style="border-bottom: outset; background-color: #a9a9a9;"><a href="chat-home.php?user_id=', $_SESSION['user']['user_id'], '">チャット</a></li>'; ?>
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="tag_list.php">みんなのタグ</a></li>
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="my_tag.php">MYタグ</a></li>
        <li style="border-bottom: outset; background-color: #a9a9a9;"><a href="announce.php">アナウンス</a></li>
        <!-- 以下ログアウト -->
