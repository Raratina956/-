...
<body>
    ...
    <div class="container">
        ...
        // 学外
        echo '<div class="gakugai-container"><li><a  href="mapindex.php"><img class="g-img" src="img/gakugai.png" width="150px" height="150px"></a></li><li><a style="position: absolute;top: 117px;left: 30px;">学外はこちら</a></li></div>';
