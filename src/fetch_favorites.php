...
if ($list_raw) {
    ...
    foreach ($list_raw as $favorite) {
        ...
        echo '<td><a href="user.php?user_id=', $follower_id, '"><img src="'.$icon_name.'" width="100" height="100" class="usericon" title="'.$favorite['user_name'].'"></a><a href="user.php?user_id=', $follower_id, '" class="atag">', $favorite['user_name'], '</a></td>';
        ?>
