...
followedUsers.forEach(user => {
    ...
    listItem.innerHTML = `
        <img src="${user.icon_name || 'default-icon.png'}" alt="${user.user_name}のアイコン" style="width: 40px; height: 40px;">
        ${user.user_name}
    `;
    ...
    if (user.latitude && user.longitude) {
        ...
        markerElement.style.backgroundImage = `url(${user.icon_name || 'default-icon.png'})`;
