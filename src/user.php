...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/user.css" media="screen and (max-width: 1280px)">
        <link rel="stylesheet" type="text/css" href="css/user-mob.css" media="screen and (max-width: 480px)">
        <link rel="stylesheet" type="text/css" href="css/user-mob.css" media="screen and (min-width: 480px)">
